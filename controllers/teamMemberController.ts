 ...
 */
export async function getAssociatePrefillController(req: Request, res: Response): Promise<Response> {
  try {
 ...
 */
export async function getAssociateTeamMembersController(req: Request, res: Response): Promise<Response> {
  try {
 ...
 */
export async function getTeamMemberByIdController(req: Request, res: Response): Promise<Response> {
  try {
 ...
 */
export async function createTeamMemberController(req: Request, res: Response): Promise<Response> {
  try {
    const authUser = (req as any).user;
    const authUserId = authUser?.user_id || authUser?.id;
    ...
    let applicantSigUrl: string | null = null;
    let associateSigUrl: string | null = null;
 ...
 */
export async function updateTeamMemberController(req: Request, res: Response): Promise<Response> {
  try {
    const id = String(req.params.id);
    const authUser = (req as any).user;
    const authUserId = authUser?.user_id || authUser?.id;
    ...
    const updated = await updateTeamMemberRecord(
      id,
      body,
      photoUrl,
      applicantSigUrl,
 ...
 */
export async function updateTeamMemberStatusController(req: Request, res: Response): Promise<Response> {
  try {
    const id = String(req.params.id);
